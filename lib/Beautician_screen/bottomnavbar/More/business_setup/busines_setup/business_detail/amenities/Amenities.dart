...
class _AmenitiesState extends State<Amenities> {
              ...
              ? Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      textComoonfade(
                          "Build trust and comfort by informing your customers about the amenities that make your business stand out.",
                          12,
                          Color(0xff414141),
                          FontWeight.w500),
                      SizedBox(
                      ...
                      textComoon("Choose from the list", 14, Color(0xff292929),
                          FontWeight.w700),
                      SizedBox(
                        height: height * 0.025,
                      ),
                              ...
                              children: [
                                Row(
                                  children: [
                                    Transform.scale(
                                      ...
                                      child: Checkbox(
                                        ...
                                        onChanged: (bool? value) {
                                          setState(() {
                                            amenity!.data[index].isSelected =
                                                value!;
                                            amenity!.data[index].isSelected
                                                ? amenityIds.add(
                                                    amenity!.data[index].id)
                                                : amenityIds.remove(
                                                    amenity!.data[index].id);
                                    ...
                                    textComoon("${amenity!.data[index].name}",
                                        14, Color(0xff292929), FontWeight.w500),
                                  ],
                                ),
                                Padding(
  ...
  saveAmenities() async {
    ...
    var Body = {"amenityIds": amenityIds};
  ...
  getAmenitySelected() async {
    ...
    var response = await http.get(
        Uri.parse(
          "https://sliike-server.onrender.com/api/v1/beautician/getAmenities",
        ),
      ...
      setState(() {
        ...
        for (int i = 0; i < amenity!.data.length; i++) {
          for (int j = 0; j < selectedAmenties!.data.length; j++) {
            if (selectedAmenties!.data[j].id.toLowerCase() ==
                amenity!.data[i].id.toLowerCase()) {
              setState(() {
