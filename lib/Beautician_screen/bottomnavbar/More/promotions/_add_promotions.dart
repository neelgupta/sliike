              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      onTap: () {
                        if (widget.type == "1") {
                          ...
                          showToast(
                              message: "Cannot Add promotions for Service");
                        }
                      },
                      child: Container(
                        padding:
                    ...
                    //       });
                    //     }else{
                    //       showToast(message: "Cannot Add promotions for Product");
                    //     }
                    //   },
                    //   child: Container(
                    //     padding:
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (getServicesListData?.data?.category != null)
                                      ...
                                      for (int j = 0;
                                        ...
                                        if (selectedvaluemin ==
                                            getServicesListData!
                                                ...
                                                .category![i]
                                                .serviceCategoryName) {
                                          serviceList.add(getServicesListData!
                                              .data!
                                              .category![i]
                                              .serviceType![j]
                                              .serviceTypeName!);
                                          service = getServicesListData!
                                              .data!
                                              .category![i]
                                              .serviceType![j]
                                              .serviceTypeName!;
                                          serviceId = getServicesListData!
                                              .data!
                                              .category![i]
                                              .serviceType![j]
                                              .bServiceId!;
                            ...
                            Container(
                                child: textComoon("Set Promo Discount", 16,
                                      ...
                                      child: TextField(
                                        ...
                                        onChanged: (value) {
                                          ...
                                          if (_radioSelected == 1 && x! > 100) {
                                            showToast(
                                                message:
                                                    "Percentage value cannot be more then 100");
                                          }
                                        },
                                        decoration: InputDecoration(
                                          contentPadding:
                            ...
                            Container(
                                child: textComoon("Set Promo Dates", 16,
                                    Color(0xff292929), FontWeight.w700)),
                            SizedBox(
                              height: height * 0.015,
                            ),
                              ...
                              child: TextField(
                                onTap: () async {
                                  ...
                                  if (picked != null &&
                                    ...
                                    Startdate.text =
                                        DateFormat('E, MMM d').format(picked);
                                    print(selectedDate);
                                  }
                                },
                                readOnly: true,
                                    ...
                                    onTap: () async {
                                      ...
                                      if (picked != null &&
                                        ...
                                        StartDate = DateFormat('yyyy-MM-dd')
                                            .format(picked);
                                        Startdate.text = DateFormat('E, MMM d')
                                            .format(picked);
                                        print(selectedDate);
                                      }
                                    },
                                  ...
                                  if (picked != null) {
                                   setState(() {
                                    ...
                                    if (Startdate.text == Enddate.text) {
                                      Enddate.clear();
                                      showToast(message: "Invalid End Date!");
                                    }
                                   });
                                  }
                                },
                                ...
                                decoration: InputDecoration(
                                  ...
                                  prefixIcon: InkWell(
                                    onTap: () async {
                                      ...
                                      //       .format(picked);
                                      //   Enddate.text = DateFormat('E, MMM d')
                                      //       .format(picked);
                            ...
                            CommonButton(context, "CONTINUE", 12,
                                FontWeight.w600, Colors.white, () {
                              if (promotionFor.isEmpty) {
                                showToast(
                                    message: "Please fill promotion category");
                              } else if (svpromotiontitle.text.isEmpty) {
                                showToast(
                                    message: "Please fill promotion title");
                              } else if (selectedvaluemin == null) {
                                showToast(
                                    message:
                                        "Please select your service category");
                              } else if (service == null) {
                                showToast(message: "Please fill service name");
                              } else if (Productprice.text.isEmpty) {
                                showToast(message: "Please fill discount");
                              } else if (Startdate.text.isEmpty) {
                                showToast(message: "Please fill start date");
                              } else if (Enddate.text.isEmpty) {
                                showToast(message: "Please fill end date");
                              } else {
                                if (type == "1") {
                                  var Body = {
                                  ...
                                  showToast(
                                      message: "Invalid promotion selection");
                                }
                              }
                            }),
                            SizedBox(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (getProductListData?.data?.category != null)
                              DropdownButtonFormField(
                                hint: Text(
                                    textAlign: TextAlign.left,
                                      ...
                                      for (int j = 0;
                                          j <
                                              getProductListData!
                                                  ...
                                                  .length;
                                          j++) {
                                        if (selectedvaluemin2 ==
                                            getProductListData!
                                                .data!
                                                .category![i]
                                                .productCategoryName) {
                                          productList.add(getProductListData!
                                              .data!
                                              .category![i]
                                              .productList![j]
                                              .productName!);
                                          product = getProductListData!
                                              .data!
                                              .category![i]
                                              .productList![j]
                                              .productName!;
                                          productId = getProductListData!
                                              .data!
                                              .category![i]
                                              .productList![j]
                                              .productId!;
                                ...
                                setState(() {
                                  ...
                                  for (int i = 0;
                                    ...
                                    for (int j = 0;
                                        ...
                                        j++) {
                                      if (product ==
                                          getProductListData!.data!.category![i]
                            ...
                            CommonButton(context, "CONTINUE", 12,
                                FontWeight.w600, Colors.white, () {
                              if (prpromotiontitle.text.isEmpty) {
                                showToast(
                                    message: "Please Enter Promotion Title");
                              } else if (promotionFor.isEmpty) {
                                showToast(
                                    message:
                                ...
                                showToast(message: "Please Enter Service Name");
                              } else if (Productprice2.text.isEmpty) {
                                showToast(message: "Please Enter Discount");
                              } else if (Startdate2.text.isEmpty) {
                                showToast(message: "Please Select Start Date");
                              } else if (Enddate2.text.isEmpty) {
                                showToast(message: "Please Select End Date");
                              } else {
                                if (type == "2") {
                                  var Body = {
                                    "promotionFor": promotionFor,
