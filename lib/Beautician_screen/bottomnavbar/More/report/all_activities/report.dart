      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              textComoon("Dashboard", 16, Colors.black, FontWeight.w700),
              SizedBox(
                height: height * 0.01,
              ),
              textComoonfade(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        textComoon(
                            "TODAY", 10, Color(0xff414141), FontWeight.w500),
                      ],
                    ),
                  ),
                  Expanded(
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      textComoon("Appointment Activities", 16, Colors.black,
                          FontWeight.w700),
                      SizedBox(
                        height: height * 0.02,
                      ),
                      Row(
                        ...
                        children: [
                          ...
                          textComoon(
                              "0", 12, Color(0xff111111), FontWeight.w600),
                        ],
                      ),
                      SizedBox(
                        height: height * 0.02,
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          textComoon("Completed:", 12, Color(0xff414141),
                              FontWeight.w500),
                          textComoon(
                              "0", 12, Color(0xff111111), FontWeight.w600),
                        ],
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          textComoon("Not Completed:", 12, Color(0xff414141),
                              FontWeight.w500),
                          textComoon(
                              "0", 12, Color(0xff111111), FontWeight.w600),
                        ],
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          textComoon("Cancelled:", 12, Color(0xff414141),
                              FontWeight.w500),
                          textComoon(
                              "0", 12, Color(0xff111111), FontWeight.w600),
                        ],
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          textComoon("No-show:", 12, Color(0xff414141),
                              FontWeight.w500),
                          textComoon(
                              "0", 12, Color(0xff111111), FontWeight.w600),
                        ],
                ...
                children: [
                  Expanded(
                    child: Container(
                        ...
                        child: textComoon("Upcoming appointments", 14,
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Padding(
                          ...
                          child: DataTable(
                            headingRowColor: MaterialStateProperty.all(Color(0xffE7E7E7)),
                            dataRowHeight: 70,
                            showCheckboxColumn: true,
                            columns: [
                              DataColumn(
                                label: textComoon("Service", 10,
                                    Color(0xff707070), FontWeight.w500),
                              ),
                              DataColumn(
                                label: textComoon("Client", 10,
                                    Color(0xff707070), FontWeight.w500),
                              ),
                              DataColumn(
                                label: textComoon("Date & time", 10,
                                    Color(0xff707070), FontWeight.w500),
                              ),
                              DataColumn(
                                label: textComoon("Service location", 10,
                                    Color(0xff707070), FontWeight.w500),
                              ),
                              DataColumn(
                                label: textComoon("Service fee", 10,
                                    Color(0xff707070), FontWeight.w500),
                              ),
                              DataColumn(
                              ...
                              DataColumn(
                                label: textComoon("Total amount", 10,
                                    Color(0xff707070), FontWeight.w500),
                              ),
                              DataColumn(
                            ...
                            rows: List<DataRow>.generate(
                              ...
                              (int index) => DataRow(
                                cells: <DataCell>[
                                  DataCell(textComoon("Nail Polish", 10,
                                      Color(0xff111111), FontWeight.w500)),
                                  DataCell(textComoon("Esther Combs", 10,
                                      Color(0xff111111), FontWeight.w500)),
                                  DataCell(
                                      Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            textComoon("20 Oct, 2022", 10,
                                            Color(0xff111111), FontWeight.w500),
                                            textComoon("8:00 - 8:30", 10,
                                                Color(0xff414141), FontWeight.w500),
                                          ],
                                        ),
                                      )),
                                  DataCell(textComoon("At the salon", 10,
                                      Color(0xff111111), FontWeight.w500)),
                                  DataCell(textComoon("\$30.00", 10,
                                      Color(0xff111111), FontWeight.w500)),
                                  ...
                                  DataCell(textComoon("\$0.00", 10,
                                      Color(0xff111111), FontWeight.w500)),
                                  DataCell(textComoon("\$39.00", 10,
                                      Color(0xff111111), FontWeight.w500)),
                                  DataCell(textComoon("Upcoming", 10,
                                      Color(0xffF2994A), FontWeight.w500)),
                                ],
                          ...
                          child: DataTable(
                            ...
                            rows: List<DataRow>.generate(
                              ...
                              (int index) => DataRow(
                                cells: <DataCell>[
                                  DataCell(
                                      textComoon("Hair Clipper", 10,
                                      Color(0xff111111), FontWeight.w500)),
                                  DataCell(Container(width: width*0.2,
                                    child: textComoonfade("Fresh Cutz Barber", 10,
                                        Color(0xff111111), FontWeight.w500),
                                  )),
                      ...
                      AspectRatio(
                        ...
                        child: DChartBarCustom(
                          ...
                          listData: [
                            ...
                            DChartBarDataCustom(value: 10, label: 'Jan'),
