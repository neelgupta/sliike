                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        // SizedBox(height: height * 0.01,),
                        Divider(
                            color: Colors.black54, endIndent: 20, indent: 20),
                        SizedBox(
                          height: height * 0.01,
                        ),
                        Padding(
                        ...
                        Divider(
                            color: Colors.black54, indent: 20, endIndent: 20),
                      ],
                    ),
                            ...
                            Navigator.push(context, MaterialPageRoute(
                              builder: (context) {
                                return manage_appoinment(
                                  category: onlyonemodal!.data!.serviceId!
                                      .serviceType!.serviceTypeName,
                                  time: "$startData - $endData",
                                  businessName: onlyonemodal!
                                      .data!.beauticianId!.businessName,
                                  bookingId: widget.id,
                                  price:
                                      "${onlyonemodal!.data!.serviceId!.price}",
                                  serviceDuration:
                                  ...
                                  beauticianId: onlyonemodal!
                                      ...
                                      photo: onlyonemodal!.data!.beauticianId!.logo ?? '',
                                );
                              },
                            ));
                          },
