...
class _booking_SettingState extends State<booking_Setting> {
  ...
  List BookingWindowList = [
    {"id":"00:15","value":'No less than 15 mins in advance',},
    {"id":"00:30","value":'No less than 30 mins in advance',},
    {"id":"01:00","value":'No less than 1 hour in advance',},
    {"id":"02:00","value":'No less than 2 hours in advance',},
    {"id":"03:00","value":'No less than 3 hours in advance',},
    {"id":"06:00","value":'No less than 6 hours in advance',},
    {"id":"12:00","value":'No less than 12 hours in advance',},
    {"id":"24:00","value":'No less than 1 day in advance',},
    {"id":"48:00","value":'No less than 2 days in advance',},
    {"id":"72:00","value":'No less than 3 days in advance',},
    {"id":"120:00","value":'No less than 5 days in advance',},
    {"id":"144:00","value":'No less than 7 days in advance',},
  ];
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  textComoon("Automatic booking confirmation", 16, Color(0xff292929),
                      FontWeight.w700),
                  FlutterSwitch(
                    width: 55.0,
                    height: 25.0,
            ...
            Padding(
              padding: const EdgeInsets.only(left: 20,right: 20),
              child: Text('Automatic booking confirmation when turned\non, can save time and make it easier for clients\nto book. ',
                  style: TextStyle(
                    fontSize: 13,
                    fontFamily: 'spartan',
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Expanded(child: Text(selectdradioValue.isNotEmpty ? selectdradioValue : "Booking Window")),
            ...
            InkWell(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  futureselectdradioValue = futureWindowList[index]['value'].toString();
                                  setState(() {});
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Radio<String>(
                                                value: futureWindowList[index]['value'],
                                                activeColor: Color(0xff01635D),
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Expanded(child: Text(futureselectdradioValue.isNotEmpty ? futureselectdradioValue : "Future Booking Window")),
                    Icon(Icons.keyboard_arrow_down,color: Colors.black38,),
                  ],
                ),
              ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Expanded(child: Text(ReschedulingselectdradioValue.isNotEmpty ? ReschedulingselectdradioValue : "Rescheduling")),
                    Icon(Icons.keyboard_arrow_down,color: Colors.black38,),
                  ],
                ),
              ),
  ...
  getData() async {
    ...
    if(response.statusCode==200) {
      BookingSetting bookingSetting = BookingSetting.fromJson(jsonDecode(response.body));
      if(bookingSetting.data!=null) {
        for(int i = 0;i<BookingWindowList.length;i++) {
          if(bookingSetting.data!.bookingWindow==BookingWindowList[i]['id']) {
        ...
        for(int i = 0;i<ReschedulingWindowList.length;i++) {
          if(bookingSetting.data!.rescheduling==ReschedulingWindowList[i]['id']) {
  ...
  updateData() async {
    ...
    print(body);
    Response response = await businessSetupService.updateBookingSetting(jsonEncode(body));
