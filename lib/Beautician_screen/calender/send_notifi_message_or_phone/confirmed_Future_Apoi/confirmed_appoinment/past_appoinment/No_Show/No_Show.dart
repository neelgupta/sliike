...
class no_Show extends StatefulWidget {
  const no_Show({Key? key}) : super(key: key);

  @override
  State<no_Show> createState() => _no_ShowState();
}

// ignore: camel_case_types
class _no_ShowState extends State<no_Show> {
  @override
                                      ...
                                      InkWell(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            const SizedBox(width: 20,),
                                            textComoon("Mark as delivered", 14, const Color(0xff111111),
                                                FontWeight.w500),
                                          ],
                                        ),
                                      ),
