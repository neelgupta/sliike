                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: textComoon("Set Time & Calendar", 16,
                          ...
                          Padding(
                            ...
                            child: textComoon("Time Format", 12,
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                top: height * 0.03, bottom: height * 0.01),
                            child: textComoon("Start Week", 12,
                                Color(0xff292929), FontWeight.w700),
                          ),
                          Container(
                          ...
                          Padding(
                            padding: EdgeInsets.only(top: height * 0.02),
                            child: textComoon("Social Media", 16, Colors.black,
                                FontWeight.w700),
                          ),
                          Padding(
                            padding: EdgeInsets.only(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        beauticianServiceId: json["beauticianServiceId"] == null
            ? []
        ...
        demographicIds: json["demographicIds"] == null
            ? []
            : List<String>.from(json["demographicIds"]!.map((x) => x)),
        amenityIds: json["amenityIds"] == null
            ? []
            : List<String>.from(json["amenityIds"]!.map((x) => x)),
        healthSafety: json["healthSafety"] == null
            ? null
            : HealthSafety.fromJson(json["healthSafety"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "country": country,
        "country_code": countryCode,
        "beauticianServiceId": beauticianServiceId == null
            ? []
        ...
        "demographicIds": demographicIds == null
            ? []
            : List<dynamic>.from(demographicIds!.map((x) => x)),
        "amenityIds": amenityIds == null
            ? []
            : List<dynamic>.from(amenityIds!.map((x) => x)),
...
class HealthSafety {
  ...
  factory HealthSafety.fromJson(Map<String, dynamic> json) => HealthSafety(
        ...
        healthId: json["healthId"] == null
            ? []
            : List<dynamic>.from(json["healthId"]!.map((x) => x)),
      );

  Map<String, dynamic> toJson() => {
        "detailForClient": detailForClient,
        "healthId":
            healthId == null ? [] : List<dynamic>.from(healthId!.map((x) => x)),
      };
}
