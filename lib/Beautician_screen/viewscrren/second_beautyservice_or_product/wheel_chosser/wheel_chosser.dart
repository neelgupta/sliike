...
class WheelChooser<T> extends StatefulWidget {
  ...
  const WheelChooser.choices({super.key,
    ...
    this.controller,
    this.horizontal = false,
    this.isInfinite = false, this.physics,
  })  : assert(perspective <= 0.01),
        assert(controller == null || startPosition == null),
        children = null, datas = null, onValueChanged = null;


  WheelChooser.custom({super.key,
    required this.onValueChanged,
  ...
  WheelChooser.integer({super.key,
    required this.onValueChanged,
  ...
  WheelChooser.number({super.key,
    ...
    this.isInfinite = false,
    this.physics,
    bool reverse = false, this.onChoiceChanged, this.choices,
  })  : assert(perspective <= 0.01),
        assert(minValue < maxValue),
        assert(initValue == null || initValue >= minValue),
        assert(initValue == null || maxValue >= initValue),
  ...
  const WheelChooser.byController({super.key,
