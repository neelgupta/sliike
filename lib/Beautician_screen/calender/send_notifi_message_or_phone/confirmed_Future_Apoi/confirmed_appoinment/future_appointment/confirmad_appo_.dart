...
import '../../../../../bottomnavbar/calender/send_notifi_message_or_phone/payment_detail/confirmed_payment.dart';
...
class confirmed_fut_appoinment extends StatefulWidget {
  ...
  @override
  State<confirmed_fut_appoinment> createState() => _future_appoinmentState();
}

// ignore: camel_case_types
class _future_appoinmentState extends State<confirmed_fut_appoinment> {
  @override
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Container(
                              ...
                              child: const Image(
                                image:
                                    AssetImage("assets/images/back-white.png"),
                                color: Colors.white,
                              )),
                        ),
                      ),
        ...
        child: SizedBox(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20,right: 20),
                child: CommonButton(context,"EDIT APPOINTMENT", 12, FontWeight.w600, Colors.white, () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return const edit_add_service();
                  },));
                }),
