...
import '../../../../../bottomnavbar/calender/send_notifi_message_or_phone/confirmed_Future_Apoi/confirmed_appoinment/past_appoinment/dlivered/dliverd.dart';
import '../../../../../custom_widget/ButtonCommon/Button.dart';

// ignore: camel_case_types
class confirmed_Apoi_Past extends StatefulWidget {
  const confirmed_Apoi_Past({Key? key}) : super(key: key);

  @override
  State<confirmed_Apoi_Past> createState() => _confirmed_Apoi_PastState();
}

// ignore: camel_case_types
class _confirmed_Apoi_PastState extends State<confirmed_Apoi_Past> {
  @override
                                      ...
                                      InkWell(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            textComoon("Mark as dlivered", 14, const Color(0xff111111),
                                                FontWeight.w500),
                                          ],
                                        ),
                                      ),
        ...
        child: SizedBox(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20,right: 20),
                child: CommonButton(context,"MARK AS DELIVERED", 12, FontWeight.w600, Colors.white, () { }),
              ),],
          ),
        ),
      ),
