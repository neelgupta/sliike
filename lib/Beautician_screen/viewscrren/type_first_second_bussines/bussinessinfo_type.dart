        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
              decoration: BoxDecoration(
                border: _radioValue1==0?Border.all(width: 1, color: const Color(0xff707070),):
                Border.all(width: 1, color: const Color(0xffCFCFCF),)                             ,
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Radio(value: 0, activeColor: const Color(0xff01635D), groupValue: _radioValue1, onChanged: (value) {
                        setState(() {
                          _radioValue1= value as int;
                        });
                      }),
                      const Text("I sell beauty products only",style: TextStyle(fontSize: 15,fontFamily: 'spartan',color: Color(0xff414141)),),
                    ],
                  ),
                ),
              ),
            ...
            GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: _radioValue1==1?Border.all(width: 1,color: const Color(0xff707070) ,):
                  Border.all(width: 1, color: const Color(0xffCFCFCF),),
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: Radio(value: 1, activeColor: const Color(0xff01635D), groupValue: _radioValue1, onChanged: (value) {
                          setState(() {
                            _radioValue1 = value as int;
                          });
                        }),
                      ),
                      const Text("I provide beauty services and\nalso sell beauty products.",style: TextStyle(fontSize: 15,fontFamily: 'spartan',color: Color(0xff111111)),),
                    ],
                  ),
                ),
              ),
  ...
  addBusinessType(int radioValue1) async {
    try{
      ...
      Loader.show(context,
          ...
          progressIndicator: const CircularProgressIndicator(backgroundColor: Color(0xffDD6A03)),
          // ignore: use_build_context_synchronously
          themeData: Theme.of(context)
              .copyWith(colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color(0xff01635D)))
      );
      var bodydata={
