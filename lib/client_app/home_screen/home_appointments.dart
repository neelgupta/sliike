                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      Navigator.push(context, MaterialPageRoute(
                                        builder: (context) {
                                          return const booking_delivered();
                                        },
                                      ));
                                    },
                                    child: Column(
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                            "${data[index].beauticianId!.firstName}",
                                                            style: const TextStyle(
                                                                fontSize: 12,
                                                                fontFamily:
                                                                    "spartan",
