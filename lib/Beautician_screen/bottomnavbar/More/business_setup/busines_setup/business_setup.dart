...
class business_SetUp extends StatefulWidget {
  final String email;
  bool isStripeSetUp;
  business_SetUp({Key? key, required this.email, required this.isStripeSetUp})
      : super(key: key);
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              textComoon("Beautician Details", 14,
                                  Color(0xff292929), FontWeight.w700),
                              SizedBox(
                                height: height * 0.01,
                              ),
                              textComoonfade(
                                  "Additional info on business name, photo,\nlocation, adding new team members etc.",
                                  10,
                                  Color(0xff707070),
                                  FontWeight.w500),
                            ],
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              textComoon("Service Set-Up", 14,
                                  Color(0xff292929), FontWeight.w700),
                              SizedBox(
                                height: height * 0.01,
                              ),
                              textComoonfade(
                                  "This section allows you to add more services and for your clients to see, book and pay.",
                                  10,
                                  Color(0xff707070),
                                  FontWeight.w500),
                            ],
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              textComoon("Calendar Management", 14,
                                  Color(0xff292929), FontWeight.w700),
                              SizedBox(
                                height: height * 0.01,
                              ),
                              textComoonfade(
                                  "Here is where you can update your availability for clients to see and book your services.",
                                  10,
                                  Color(0xff707070),
                                  FontWeight.w500),
                            ],
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              textComoon("Payments & Sales Tax Profile", 14,
                                  Color(0xff292929), FontWeight.w700),
                              SizedBox(
                                height: height * 0.01,
                              ),
                              textComoonfade(
                                  "Provide Bank Details and Sales Tax numbers for your beauty business.",
                                  10,
                                  Color(0xff707070),
                                  FontWeight.w500),
                            ],
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              textComoon("No-Show Protection", 14,
                                  Color(0xff292929), FontWeight.w700),
                              SizedBox(
                                height: height * 0.01,
                              ),
                              textComoonfade(
                                  "This section is used to set payment reimbursement rules when a client doesn’t show up for a service that was reserved and confirmed.",
                                  10,
                                  Color(0xff707070),
                                  FontWeight.w500),
                            ],
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              textComoon("Cancellation Policy", 14,
                                  Color(0xff292929), FontWeight.w700),
                              SizedBox(
                                height: height * 0.01,
                              ),
                              textComoonfade(
                                  "This policy allows you to set guidelines around appointment cancellations.",
                                  10,
                                  Color(0xff707070),
                                  FontWeight.w500),
                            ],
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              textComoon("Booking Settings", 14,
                                  Color(0xff292929), FontWeight.w700),
                              SizedBox(
                                height: height * 0.01,
                              ),
                              textComoonfade(
                                  "Set up when present and future bookings can be made, and the time limit when confirmed appointments can be rescheduled.",
                                  10,
                                  Color(0xff707070),
                                  FontWeight.w500),
                            ],
