          ...
          : Column(
              ...
              children: [
                SfCalendar(
                    ...
                    todayTextStyle:
                        TextStyle(fontFamily: 'spartan', color: Colors.white),
                ...
                Padding(
                  ...
                  child: textComoon(
                      "Independently adjust work hours for any day.",
                      11,
                      Color(0xff414141),
                      FontWeight.w500),
                ),
                    ...
                    child: InkWell(
                        ...
                        Navigator.push(context, MaterialPageRoute(
                          builder: (context) {
                            return add_Your_Work_Hours(
                              ...
                              breakendTime:
                                  getScheduledData!.data!.breakEndTime,
                              breakstartTime:
                                  getScheduledData!.data!.breakStartTime,
                            );
                          },
                        )).then((value) {
                          print("value : ${value}");
                          ...
                          if (value != null) {
                            ...
                            setState(() {});
                            print(
                                "getScheduledData ${getScheduledData!.data!}");
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            child: getScheduledData!.data!.isOpen!
                                ? Column(
                                    crossAxisAlignment:
...
GetScheduledData getScheduledDataFromJson(String str) =>
    GetScheduledData.fromJson(json.decode(str));

String getScheduledDataToJson(GetScheduledData data) =>
...
class GetScheduledData {
  ...
  factory GetScheduledData.fromJson(Map<String, dynamic> json) =>
      GetScheduledData(
        status: json["status"],
