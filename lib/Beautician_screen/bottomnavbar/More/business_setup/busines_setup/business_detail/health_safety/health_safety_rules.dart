    ...
    return Scaffold(
        ...
        body: isLoading
            ...
            : getHealthSafetyData != null &&
                    getHealthSafetyData!.data.length != 0
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: Padding(
                                  ...
                                  child: textComoon("Select rules :", 12,
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            textComoon(
                                                "${getHealthSafetyData!.data[index].name}",
                                                14,
                                                Color(0xff292929),
                                                FontWeight.w500),
                                          ],
                              ...
                              child: InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        textComoon("Additional Details", 14,
                                            Color(0xff292929), FontWeight.w500),
                                        textComoon("(optional)", 14,
      ...
      setState(() {
        ...
        for (int i = 0; i < getHealthSafetyData!.data.length; i++) {
          for (int j = 0; j < selectedData!.data!.healthID!.length; j++) {
            if (selectedData!.data!.healthID![j].id ==
                getHealthSafetyData!.data[i].id) {
