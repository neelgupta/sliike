...
class brands_search extends StatefulWidget {
  const brands_search({Key? key}) : super(key: key);

  @override
  State<brands_search> createState() => _brands_searchState();
}

class _brands_searchState extends State<brands_search> {
  ...
  Widget serviceSearch() {
    ...
    return Column(
      ...
      children: [
        ...
        const Text("Brands",style: TextStyle(fontFamily: "spartan",fontWeight: FontWeight.bold,fontSize: 16),),
        SizedBox(height: height*0.02,),
        Container(
          height: height*0.40,
          child: ListView.builder(
            ...
            return Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: width*0.02,),
                  const Text("Lakme hair",style: TextStyle(fontFamily: "spartan",color: Colors.black,fontSize: 12),)
                ],
              ),
            );
          },),
