...
class edit_Employe extends StatefulWidget {
  const edit_Employe({Key? key}) : super(key: key);

  @override
  State<edit_Employe> createState() => _edit_EmployeState();
}

class _edit_EmployeState extends State<edit_Employe> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              // border: Border.all(color: Color(0xff008BB7)),
                            ),
                            child: Padding(
              ...
              textComoon(
                  "Account Owner", 12, Color(0xff292929), FontWeight.w700),
              SizedBox(
                height: height * 0.01,
              ),
              Padding(
                padding: EdgeInsets.only(bottom: height * 0.02),
                child: textComoonfade(
                    "Account owner has the highest permission level and can manage all details for this account.",
                    12,
                    Color(0xff414141),
                    FontWeight.w500),
              ),
