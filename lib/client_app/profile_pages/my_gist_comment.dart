...
class my_gist_comment extends StatefulWidget {
  const my_gist_comment({Key? key}) : super(key: key);

  @override
  State<my_gist_comment> createState() => _my_gist_commentState();
}

class _my_gist_commentState extends State<my_gist_comment> {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Image.asset("assets/images/Group 12788.png",height: height*0.10),
                  ],
                ),
              ),
            ],
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: const Color(0xFFFCE8CA)
                        ),
                        child: const Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sed lacus id metus semper dictum. In hac habitasse plates dictumst. Nullam hendrerit dictum magna, vitae aliquet turpis rutrum commodo.",
                            style: TextStyle(
                              fontSize: 16,
                              fontFamily: "spartan",
                              color: Colors.black54,
