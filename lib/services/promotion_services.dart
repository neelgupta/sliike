...
class PromotionServices{
  ...
  addPromotion(BuildContext context,Body) async {
    var getUri = "https://sliike-server.onrender.com/api/v1/beautician/addPromotion";
    try {
      Loader.show(
        context,
        isSafeAreaOverlay: false,
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => promotion(),));
        Loader.hide();
      }else if(response.statusCode == 401){
        Loader.hide();
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) {
  ...
  getServices(BuildContext context) async {
    try {
      ...
      var response = await http.get(
        Uri.parse("https://sliike-server.onrender.com/api/v1/beautician/getPromotionList/service"),
        headers: headers,
      );
  ...
  getProducts(BuildContext context) async {
    try {
      ...
      var response = await http.get(
        Uri.parse("https://sliike-server.onrender.com/api/v1/beautician/getPromotionList/product"),
        headers: headers,
      );
