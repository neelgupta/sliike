...
class cancellation_PolicyState extends State<cancellation_Policy> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          textComoonfade(
                              "Protect your business by setting rules against last minute appointment cancellation.",
                              12,
                              Color(0xff414141),
                              FontWeight.w500),
                        ],
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                textComoon("Set-Up Cancellation policy", 14,
                                    Color(0xff111111), FontWeight.w700),
                                SizedBox(
                                  height: height * 0.01,
                                ),
                                textComoonfade(
                                    "Choose when appointments can be cancelled by clients.",
                                    12,
                                    Color(0xff414141),
                                    FontWeight.w500),
                              ],
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              textComoon("Free", 14, Color(0xff111111),
                                  FontWeight.w700),
                            ],
                          ),
                          // SizedBox(height: height*0.01,),
                          textComoonfade(
                              "Cancellation allowed at any time. Full refund. ",
                              12,
                              Color(0xff414141),
                              FontWeight.w500),
                        ],
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              textComoon("Flexible", 14, Color(0xff111111),
                                  FontWeight.w700),
                            ],
                          ),
                          // SizedBox(height: height*0.01,),
                          textComoonfade(
                              "Cancellation allowed between 7 to 24 hours before the appointment. Full refund. ",
                              12,
                              Color(0xff414141),
                              FontWeight.w500),
                        ],
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              textComoon("Strict", 14, Color(0xff111111),
                                  FontWeight.w700),
                            ],
                          ),
                          // SizedBox(height: height*0.01,),
                          textComoonfade(
                              "50% charge on cancellation between 24 and 10 hours before the appointment. 50% refund. ",
                              12,
                              Color(0xff414141),
                              FontWeight.w500),
                        ],
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          textComoonfade(
                              "Full charge on cancellation less than 10 hours before the appointment. No refund. ",
                              12,
                              Color(0xff414141),
                              FontWeight.w500),
                        ],
  ...
  getStatus() async {
    ...
    if (response.statusCode == 200) {
      cancellationStatus =
          jsonDecode(response.body)['data']['cancelProtection'] ?? 1;
    } else {
