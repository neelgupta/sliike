          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(top: 68,right: 5),
                    child: SizedBox(
                      height: height*0.06,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          child: const Text("view_all",style: TextStyle(color: Color(0xFFDD5103),fontSize: 14,fontFamily: "spartan",)).tr(),
                        ),
                      ],
                    ),
                  ],
                        ...
                        Padding(padding: const EdgeInsets.only(left: 15,),
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text("\$999",style: TextStyle(color: Colors.black,fontSize: 16,fontFamily: "spartan")),
                              ],
                            )
                        )
                      ],
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Container(
                          child: const Text("recently_viewed",style: TextStyle(color: Colors.black,fontSize: 20,fontFamily: "spartan",fontWeight: FontWeight.w600)).tr(),
                        ),
                        Container(
                          child: const Text("view_all",style: TextStyle(color: Color(0xFFDD5103),fontSize: 14,fontFamily: "spartan",)).tr(),
                        ),
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Container(
                          child: const Text("recommended",style: TextStyle(color: Colors.black,fontSize: 20,fontFamily: "spartan",fontWeight: FontWeight.w600)).tr(),
                        ),
                        Container(
                          child: const Text("view_all",style: TextStyle(color: Color(0xFFDD5103),fontSize: 14,fontFamily: "spartan",)).tr(),
                        ),
